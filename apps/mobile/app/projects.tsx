...
export default function Screen() {
  return (
    <SafeAreaView style={ flex: 1, padding: 16 }>
      <Text style={ color: "white", fontSize: 22, fontWeight: "700" }>Projects</Text>
      <Text style={ color: "#a1a1aa", marginTop: 10, lineHeight: 20 }>
        Showcase mobile-friendly project cards here. Later, sync with the same backend as the web dashboard.
      </Text>
